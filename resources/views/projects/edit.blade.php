    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ __('project.edit_title') }}</h1>
                        <p class="text-gray-500 dark:text-gray-400 mt-2">{{ __('project.edit_intro') }}</p>
                    </div>
                    ...
                    <form method="post" action="{{ route('projects.update', $project) }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="number"
                                              ...
                                              disabled />
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('project.number_immutable') }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('project.name_help') }}</p>
                            </div>

                            <!-- Client -->
                            <div>
                                <x-input-label for="client" :value="__('project.client')" />
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('project.image_help') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                            <h2 class="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">{{ __('project.preview') }}</h2>
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                <div class="flex items-center rounded-xl border border-gray-200 dark:border-gray-600">
                                     <img id="preview-image" src="{{ $project->thumbnail ? asset('storage/images/projects/'.$project->thumbnail) : Vite::asset('resources/images/thumb-image.png') }}"
                                    ...
                                    <div class="flex-1 ml-4">
                                        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100" id="preview-name">
                                            {{ $project->name ?? old('name') ?: __('project.name') }}
                                        </h2>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                nameInput.addEventListener('input', function() {
                    previewName.textContent = this.value || @json(__('project.name'));
                });
