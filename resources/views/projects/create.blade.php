    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ __('project.create_title') }}</h1>
                        <p class="text-gray-500 dark:text-gray-400 mt-2">{{ __('project.create_intro') }}</p>
                    </div>
                    ...
                    <form method="post" action="{{ route('projects.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('project.identification') }}</p>
                            </div>
