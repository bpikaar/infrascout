...
{{--                                              :value="$client->number"--}}
{{--                                              disabled />--}}
{{--                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('client.number_immutable') }}</p>--}}
{{--                            </div>--}}
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('client.name_help') }}</p>
                            </div>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                                <div class="flex items-center rounded-xl border border-gray-200 dark:border-gray-600">
                                     <img id="preview-image" src="{{ $client->thumbnail ? asset('storage/images/clients/'.$client->thumbnail) : Vite::asset('resources/images/thumb-image.png') }}"
                                    ...
                                    <div class="flex-1 ml-4">
                                        ...
                                        <p class="text-sm text-gray-500">
                                            #<span id="preview-number">{{ $client->number ?? old('number') ?: '000' }}</span> • {{ now()->toFormattedDayDateString() }}
                                        </p>
                                    </div>
                                </div>
                            </div>
