...
@if($report->cableFailure)
    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
        ...
        @if($methodeDescription)
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-200 leading-relaxed whitespace-pre-line bg-white/70 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-600 rounded-md p-3">
                {{ $methodeDescription }}
            </p>
        @endif
