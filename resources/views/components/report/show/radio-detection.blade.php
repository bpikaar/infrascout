        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            @if($report->radioDetection->sonde_type)
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">{{ \App\Models\RadioDetection::signalDescriptionFor(\App\Enums\MethodType::SignalSonde->value) }}</p>
                </div>
            ...
            @if($report->radioDetection->geleider_frequentie)
                <div class="flex flex-col">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">{{ \App\Models\RadioDetection::signalDescriptionFor(\App\Enums\MethodType::SignalGeleider->value) }}</p>
                </div>
