...
<a href="{{ route('projects.show', $project) }}">
    <div class="flex items-center rounded-xl border border-gray-200 hover:border-blue-400 hover:cursor-pointer group">
        <img src="{{ $project->thumbnail_url ?? Vite::asset('resources/images/thumb-image.png') }}" alt="{{ $project->name }} thumbnail" class="h-full aspect-square rounded-l-xl rounded-r-none object-cover" style="min-width: 64px; max-width: 128px;" />
