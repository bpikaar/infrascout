            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 py-4" x-data="reportUploadProgress()">
                        ...
                        <form method="POST" action="{{ route('clients.reports.store', old('client_id') ?? request('client')) }}" enctype="multipart/form-data" class="space-y-6" @submit.prevent="submitForm">
                            @csrf
